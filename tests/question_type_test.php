...
require_once($CFG->dirroot . '/question/type/minispeak/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/minispeak/edit_minispeak_form.php');

/**
 * Unit tests for the Minispeak question definition class.
 *
...
class question_type_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        $this->qtype = new qtype_minispeak();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'minispeak');
    }
    ...
    public function test_question_saving_two_of_four($which) {
        ...
        $questiondata = \test_question_maker::get_question_data('minispeak', $which);
        $formdata = \test_question_maker::get_question_form_data('minispeak', $which);

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_minispeak_edit_form::mock_submit((array)$formdata);

        $form = \qtype_minispeak_test_helper::get_question_editing_form($cat, $questiondata);
    ...
    public function test_get_question_options() {
        ...
        $questiondata = \test_question_maker::get_question_data('minispeak', 'two_of_four');
        $formdata = \test_question_maker::get_question_form_data('minispeak', 'two_of_four');
        ...
        $DB->delete_records('qtype_minispeak_options', ['questionid' => $question->id]);
        ...
        $this->assertEquals(get_config('qtype_minispeak', 'answerhowmany'), $options->single);
