 ...
 *
 * Note, there are already lots of tests of the minispeak type in the behaviour
 * tests. (Search for \test_question_maker::make_a_minispeak.) This file only
 * contains a few additional tests for problems that were found during testing.
 *
 * @package    qtype_minispeak
 * @copyright  2010 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \qtype_minispeak_single_question
 * @covers     \qtype_minispeak_single_base
 */
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_minispeak_single() {

        // Create a minispeak, single question.
        $mc = \test_question_maker::make_a_minispeak_single_question();
        ...
        $oldmc = \test_question_maker::make_a_minispeak_single_question();
        $oldmc->answers = [
            23 => $oldmc->answers[13],
            24 => $oldmc->answers[14],
            25 => $oldmc->answers[15],
        ...
        $this->assertStringNotContainsString(
                get_string('deletedchoice', 'qtype_minispeak'), $this->currentoutput);
    }

    public function test_deferredfeedback_feedback_minispeak_single_showstandardunstruction_yes() {
        ...
        $standardinstruction = get_string('selectone', 'qtype_minispeak');
        $this->assertStringContainsString($standardinstruction, $this->currentoutput);
    }

    public function test_deferredfeedback_feedback_minispeak_single_showstandardunstruction_no() {
        ...
        // Check for 'Show standard instruction'.
        $standardinstruction = get_string('selectmulti', 'qtype_minispeak');
        $this->assertStringNotContainsString($standardinstruction, $this->currentoutput);
    }

    public function test_deferredfeedback_feedback_minispeak_multi() {
        // Create a minispeak, multi question.
        $mc = \test_question_maker::make_a_minispeak_multi_question();
        $mc->shuffleanswers = false;
     ...
     */
    public function test_deferredfeedback_feedback_minispeak_clearchoice() {
    ...
    public function test_deferredfeedback_feedback_minispeak_multi_showstandardunstruction_yes() {
    ...
    public function test_deferredfeedback_feedback_minispeak_multi_showstandardunstruction_no() {
