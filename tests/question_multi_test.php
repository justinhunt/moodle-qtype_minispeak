...
/**
 * Unit tests for the Minispeak, multi-response question definition class.
 *
 * @package   qtype_minispeak
 * @copyright 2023 Justin Hunt <justin@poodll.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \qtype_minispeak_multi_question
 */
class question_multi_test extends \advanced_testcase {

    public function test_get_expected_data() {
        $question = \test_question_maker::make_a_minispeak_multi_question();
