...
Feature: Test creating a Minispeak question
  As a teacher
  In order to test my students
  I need to be able to create a Minispeak question
  ...
  Scenario: Create a Minispeak question with multiple response
    When I am on the "Course 1" "core_question > course question bank" page logged in as teacher
    And I add a "Minispeak" question filling the form with:
  ...
  @javascript
  Scenario: Create a Minispeak question with single response
    When I am on the "Course 1" "core_question > course question bank" page logged in as teacher
    And I add a "Minispeak" question filling the form with:
    ...
    And I set the field "Minispeak" to "1"
