...
Feature: Test duplicating a quiz containing a Minispeak question
  As a teacher
  In order re-use my courses containing Minispeak questions
  ...
  @javascript
  Scenario: Backup and restore a course containing a Minispeak question
