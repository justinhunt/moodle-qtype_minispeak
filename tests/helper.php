...
/**
 * Test helper code for the Minispeak question type.
 *
...
/**
 * Test helper class for the Minispeak question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_minispeak_test_helper extends question_test_helper {
     ...
     * @return object
     */
    public static function get_minispeak_question_data_two_of_four() {
        global $USER;
        ...
        $qdata->qtype = 'minispeak';
        $qdata->name = 'Minispeak question';
     ...
     * @return object
     */
    public static function get_minispeak_question_form_data_two_of_four() {
        $qdata = new stdClass();
     ...
     * @return object
     */
    public static function get_minispeak_question_data_one_of_four() {
        global $USER;
     ...
     * @return object
     */
    public static function get_minispeak_question_form_data_one_of_four() {
        $qdata = new stdClass();
