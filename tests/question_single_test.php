...
use qtype_minispeak_multi_question;
use question_answer;
...
/**
 * Unit tests for the Minispeak, single response question definition class.
 *
...
class question_single_test extends \advanced_testcase {
    ...
    public function test_get_expected_data() {
        $question = \test_question_maker::make_a_minispeak_single_question();
    ...
    public function test_grading_rounding_three_right() {
        question_bank::load_question_definition_classes('minispeak');
        $mc = new qtype_minispeak_multi_question();
        ...
        $mc->qtype = question_bank::get_qtype('minispeak');
    ...
    public function test_validate_can_regrade_with_other_version_bad() {
        ...
        $this->assertEquals(get_string('regradeissuenumchoiceschanged', 'qtype_minispeak'),
    ...
    public function test_update_attempt_state_date_from_old_version_bad() {
        ...
        $this->expectExceptionMessage(get_string('regradeissuenumchoiceschanged', 'qtype_minispeak'));
