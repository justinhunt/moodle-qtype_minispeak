/* jshint ignore:start */
define(['jquery', 'core/log','qtype_minispeak/definitions','qtype_minispeak/quizhelper','qtype_minispeak/pollyhelper'], function($,  log, def,  quizhelper,polly) {
    ...
    return {
        ...
        init: function(props){
            ...
            if(configcontrol){
                ...
                log.debug('minispeak activity Controller: No config found on page. Giving up.');
                return;
            }
        ...
        process_html: function(){
            ...
            var controls ={
                ...
                placeholder: $('.qtype_minispeak_placeholder')
            };
