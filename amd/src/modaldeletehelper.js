 ...
 *
 * @module     qtype_minispeak/modaldeletehelper
...
define(['jquery', 'core/log', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/ajax','core/notification'],
    function($, log, Str, ModalFactory, ModalEvents, Ajax, Notification) {
        ...
        TheForm.prototype.preinit = function(selector) {
            ...
            var dd=this;
            Str.get_string(this.formname , 'qtype_minispeak').then(function(title){dd.formtitle=title;});
            Str.get_string(this.formname + '_message' , 'qtype_minispeak').then(function(message){dd.formmessage=message;});
            Str.get_string('deletebuttonlabel' , 'qtype_minispeak').then(function(deletebuttonlabel){dd.deletebuttonlabel=deletebuttonlabel;});
        ...
        TheForm.prototype.submitForm = function(e) {
            ...
            Ajax.call([{
                methodname: 'qtype_minispeak_delete_item',
                args: {
                    itemid: dd.itemid,
        ...
        return /** @alias module:qtype_minispeak/modaldeletehelper */ {
