 ...
 *
 * @module     qtype_minispeak/modalpreviewhelper
...
define(['jquery', 'core/log','core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    function($, log,Str, ModalFactory, ModalEvents, Fragment, Ajax, Y) {
            ...
            $('body').on('click',selector,function(e) {
                ...
                ModalFactory.create({
                 ...
                 //   title: dd.questiontitle,
                    ...
                    dd.modal = modal;
                    //Str.get_string(dd.formname , 'qtype_minispeak').then(function(title){dd.formtitle=title;dd.modal.setTitle(dd.formtitle);});
                    ...
                    dd.modal.getRoot().on(ModalEvents.shown, function () {
                        ...
                        dd.modal.getRoot().append('<style>.minispeak_nextbutton { display: none ! important; }</style>');
                        dd.modal.getRoot().append('<style>.minispeak_quiz_progress { display: none ! important; }</style>');
                    });
        ...
        TheForm.prototype.getBody = function() {
            ...
            var html = Fragment.loadFragment('qtype_minispeak', 'preview', this.contextid, params);
            return html;
        ...
        return /** @alias module:qtype_minispeak/modalpreviewhelper */ {
