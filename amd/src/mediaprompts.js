 ...
 */
    ...
    log.debug('MiniSpeak mediaprompts: initialising');
    ...
    return{
        ...
        init: function(opts){
            ...
            $.each(opts, function(key, value){
                ...
                if(value===1){
                    var thefieldset=$('#ms_mediaprompt_panel_'+key);
                    thefieldset.show();
        ...
        init_strings: function(){
            var that = this;  
            str.get_strings([
                { "key": "reallydeletemediaprompt", "component": 'qtype_minispeak' },
                { "key": "deletemediaprompt", "component": 'qtype_minispeak' },
                { "key": "delete", "component": 'core' },
                { "key": "deletefilesfirst", "component": 'qtype_minispeak' },
                { "key": "cleartextfirst", "component": 'qtype_minispeak' },
            ]).done(function (s) {
                var i = 0;
        ...
        register_events: function(){
            ...
            this.controls.select.on('change',function(){
                ...
                var thefieldset = $('#ms_mediaprompt_panel_' + mediaprompt);
            ...
            var fieldset_close = $('.ms_mediaprompt_panel button.close');
