define(['jquery','core/log','qtype_minispeak/definitions','https://cdnjs.cloudflare.com/ajax/libs/qrcode-generator/1.3.1/qrcode.min.js'], function($,log, def, qrcode) {
    "use strict"; // jshint ;_;
 ...
 */
    ...
    log.debug('minispeak QRCode helper: initialising');
