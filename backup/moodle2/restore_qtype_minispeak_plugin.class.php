 ...
 * needed to restore one minispeak qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_minispeak_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $elepath = $this->get_pathfor('/minispeak');
    ...
    /**
     * Process the qtype/minispeak element
     */
    public function process_minispeak($data) {
        global $DB;
     ...
     * recoded pointing to all the restored stuff for minispeak questions
     *
