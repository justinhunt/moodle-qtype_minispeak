 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_minispeak_single_question extends qtype_minispeak_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_minispeak', 'single');
    }
...
/**
 * Represents a Minispeak question where Minispeaks can be selected.
 *
 * @copyright  2023 Justin Hunt <justin@poodll.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_minispeak_multi_question extends qtype_minispeak_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_minispeak', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_minispeak');
    }
